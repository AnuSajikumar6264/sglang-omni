...
def create_reference_encode_executor(
    ...
    *,
    ...
    # Resolved before the checkpoint work: a device this host cannot provide is a
    # launch error, and finding it after minutes of weight loading buries it.
...
def create_audio_decode_executor(
    ...
    *,
    ...
    if gpu_id is not None and (isinstance(gpu_id, bool) or not isinstance(gpu_id, int)):
