...
class _MingAudioStreamingRunner:
    ...
    def __init__(
        ...
        *,
        ...
        # Not accelerator_module: the runner has no CPU path to fall back to. Its
        # pinned host buffers and its graph both need a real backend, so the
        # module is resolved outright and every stream call goes through it.
    ...
    def prepare_cuda_graph(self) -> None:
        ...
        try:
            # Warmup shares the pin so the captured attention is the one warmed.
            with (
